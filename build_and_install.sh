...
bazel build -s  -c opt --copt=-O3  --config=opt  --copt=-msse4.2  --config=mkl_threadpool --define build_with_mkl_dnn_v1_only=true //tensorflow/tools/pip_package:build_pip_package
# # debug version
