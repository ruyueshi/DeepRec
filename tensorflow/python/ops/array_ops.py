...
@tf_export("one_hot_reduce_sum")
@dispatch.add_dispatch_support
def one_hot_reduce_sum(indices,
            depth,
            on_value=None,
            off_value=None,
            axis_onehot=None,
  ...
  """
  with ops.name_scope(
      name, "one_hot_reduce_sum",
      [indices, depth, on_value, off_value, axis_onehot, axis_reducesum, dtype]) as name:
    on_exists = on_value is not None
    off_exists = off_value is not None
    ...
    return gen_array_ops.one_hot_reduce_sum(indices, depth, on_value, off_value, axis_onehot,
                      axis_reducesum, name)
